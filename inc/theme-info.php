	...
	<div class="wrap theme-info-wrap">
		...
		<div class="important-links clearfix">
			<p><strong><?php esc_html_e( 'Theme Links', 'merlin' ); ?>:</strong>
				<a href="<?php echo esc_url( merlin_theme_links( 'theme_page' ) . '?utm_source=theme-info&utm_medium=textlink&utm_campaign=merlin&utm_content=theme-page' ); ?>" target="_blank"><?php esc_html_e( 'Theme Page', 'merlin' ); ?></a>
				...
				<a href="<?php echo esc_url( merlin_theme_links( 'documentation' ) . '?utm_source=theme-info&utm_medium=textlink&utm_campaign=merlin&utm_content=documentation' ); ?>" target="_blank"><?php esc_html_e( 'Theme Documentation', 'merlin' ); ?></a>
			...
			<div class="columns-wrapper clearfix">
				...
				<div class="column column-half clearfix">
					...
					<div class="section">
						...
						<p>
							<a href="<?php echo esc_url( merlin_theme_links( 'documentation' ) . '?utm_source=theme-info&utm_medium=button&utm_campaign=merlin&utm_content=documentation' ); ?>" target="_blank" class="button button-secondary">
					...
					<div class="section">
						...
						<p>
							<a href="<?php echo esc_url( merlin_theme_links( 'pro_version' ) . '?utm_source=theme-info&utm_medium=button&utm_campaign=merlin&utm_content=pro-version' ); ?>" target="_blank" class="button button-secondary">
		...
		<div id="theme-author">
			...
			<p><?php printf( esc_html__( '%1$s is proudly brought to you by %2$s. If you like this theme, %3$s :)', 'merlin' ), 
				$theme->get( 'Name' ),
				'<a target="_blank" href="' . merlin_theme_links( 'homepage' ) . '?utm_source=theme-info&utm_medium=footer&utm_campaign=merlin" title="ThemeZee">ThemeZee</a>',
