...
function merlin_customize_controls_js() {
	...
	wp_localize_script( 'merlin-customizer-controls', 'merlin_theme_links', array(
		...
		'themeURL'	=> esc_url( __( 'https://themezee.com/themes/merlin/', 'merlin' ) . '?utm_source=customizer&utm_medium=textlink&utm_campaign=merlin&utm_content=theme-page' ),
		'themeLabel'	=> esc_html__( 'Theme Page', 'merlin' ),
		'docuURL'	=> esc_url( __( 'https://themezee.com/docs/merlin-documentation/', 'merlin' ) . '?utm_source=customizer&utm_medium=textlink&utm_campaign=merlin&utm_content=documentation' ),
