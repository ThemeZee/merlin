 ...
 *
 * Prevents Merlin from running on WordPress versions prior to 4.1,
 ...
 * Merlin on WordPress versions prior to 4.1.
 *
 * @since Merlin 1.0
 */
function merlin_compat_upgrade_notice() {
	$message = sprintf( __( 'Merlin requires at least WordPress version 4.1. You are running version %s. Please upgrade and try again.', 'merlin' ), $GLOBALS['wp_version'] );
...
function merlin_compat_customize() {
	wp_die( sprintf( __( 'Merlin requires at least WordPress version 4.1. You are running version %s. Please upgrade and try again.', 'merlin' ), $GLOBALS['wp_version'] ), '', array(
		'back_link' => true,
	) );
}
...
function merlin_compat_preview() {
	if ( isset( $_GET['preview'] ) ) {
		wp_die( sprintf( __( 'Merlin requires at least WordPress version 4.1. You are running version %s. Please upgrade and try again.', 'merlin' ), $GLOBALS['wp_version'] ) );
	}
}
